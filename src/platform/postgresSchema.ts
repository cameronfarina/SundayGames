...
const platformPostgresTables = [
  ...
  },
  {
    ...
    columns: [
      ...
      { name: "fantasy_team_key", type: "text" },
      { name: "owner_name", type: "text" },
      { name: "player_id", type: "text" },
      { name: "original_player_name", type: "text" },
      { name: "position", type: "text" },
    ...
    primaryKey: ["id"],
    uniqueConstraints: [
      { name: "historical_draft_sales_batch_row_key", columns: ["import_batch_id", "source_row_number"] },
    ],
    checkConstraints: [
      { name: "historical_draft_sales_price_check", expression: "price >= 0" },
      { name: "historical_draft_sales_source_row_check", expression: "source_row_number > 0" },
    ],
    foreignKeys: [
      {
  ...
  },
  {
    ...
    primaryKey: ["id"],
    uniqueConstraints: [
      { name: "player_prices_snapshot_player_key", columns: ["pricing_snapshot_id", "player_id"] },
    ],
    checkConstraints: [
