...
export const registerLeagueSeasonInTransaction = async (
  transactionClient: PostgresQueryClient,
...
export const registerLeagueSeason = async (
  ...
  limits: LeagueCreationLimits,
  input: RegisterLeagueSeasonRepositoryInput,
): Promise<LeagueSeason> => await client.transaction(async transactionClient =>
  await registerLeagueSeasonInTransaction(transactionClient, limits, input)
);
