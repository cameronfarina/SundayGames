...
const facade = path.resolve("src/platform/http/request/domainInputs.ts");
const moduleDirectory = path.resolve("src/platform/http/request/domainInputs");
...
describe("platform HTTP domain input architecture", () => {
  it("keeps request decoders in focused, strictly typed modules", () => {
