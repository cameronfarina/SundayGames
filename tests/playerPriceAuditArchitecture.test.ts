...
const moduleRoot = join(sourceRoot, "playerPriceAudit");
...
describe("player price audit architecture", () => {
  it("keeps production modules focused and free of TypeScript escapes", async () => {
    const files = [join(sourceRoot, "playerPriceAudit.ts"), ...await moduleFiles(moduleRoot)];
