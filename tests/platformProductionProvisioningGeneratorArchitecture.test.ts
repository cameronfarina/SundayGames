...
const moduleRoot = join(platformRoot, "generateProductionProvisioning");
...
describe("production provisioning generator architecture", () => {
  it("uses focused modules without unsafe TypeScript escapes", async () => {
    ...
    const files = [
      join(platformRoot, "generateProductionProvisioning.ts"),
      ...entries
