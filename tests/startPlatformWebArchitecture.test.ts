...
const moduleRoot = join(sourceRoot, "startPlatformWeb");
...
describe("platform web startup architecture", () => {
  it("keeps the executable facade and implementation modules focused and typed", async () => {
    const files = [
      join(sourceRoot, "startPlatformWeb.ts"),
